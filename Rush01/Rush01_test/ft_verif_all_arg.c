...
/*   Updated: 2022/02/27 03:36:49 by retcheba         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	verif_all_arg(char *str, int *ext_box)
{
	if ((verif_arg_0(str)) && (verif_arg_1(str))
		...
		&& (verif_arg_4(str)) && (verif_arg_num(ext_box))
		&& ((verif_arg_5(str)) || (verif_arg_6(str))
			|| (verif_arg_7(str)) || (verif_arg_8(str)) || (verif_arg_9(str))))
		return (1);
	else
		return (0);
}
